...
let five = "earthbeat"; // beat for this element
let fileArray = []; // array of the random generated files
let buffers; // where we load the sounds
let element = "e"; // which element is this one?
let elementWord = "EARTH";
let image1;
let image2;
let image3;
let image4;
...
function welcomeScreen() {
  ...
  textSize(32);
  text(`Click to enter. Centre button starts sound. Move to explore the soundworld. Press the back button on your browser to start again`, width/10, height/10, (width/10) * 8, (height/10) * 8);
